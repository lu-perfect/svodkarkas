        ...
        <Container>
          <Box className="row">
            ...
            <Box className="col right">
              ...
              <Typography tag="p">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae placeat aspernatur aperiam,
                quisquam voluptas enim tempore ab itaque nam modi eos corrupti distinctio nobis labore dolorum quae
